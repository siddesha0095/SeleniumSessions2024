...
public class ImplictlyWaitConcept {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//dynamic wait:
		//timeout =10 secs ->>2 secs----- 8 seconds ignored
		//implicitly wait:
			//global wait : it will be applicable for all the web elements
			//FindElement : imp wait will be applied by default
		...
		// driver.manage().timeouts().implicitlyWait(Duration,ofSeconds(20)); // depreciated
