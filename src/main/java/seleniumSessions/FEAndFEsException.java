...
public class FEAndFEsException {
	...
	public static void main(String[] args) {
		...
		boolean flag = driver.findElement(By.xpath("//span[@class='sc-b323b31-0 ieRFkx'][normalize-space()='Customers']")).isDisplayed();
		System.out.println(flag);
		//NoSuchElementException
		
		//wrong selector: InvalidSelectorException
		List<WebElement> footerList = driver.findElements(By.xpath("//*[@class='sc-6293d692-0 eNMhGa']//a"));
